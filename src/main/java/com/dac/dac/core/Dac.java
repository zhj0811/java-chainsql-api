package com.dac.dac.core;

import static com.dac.base.config.Config.getB58IdentiferCodecs;
...
import com.dac.base.client.Client.OnReconnected;
import com.dac.base.client.Client.OnReconnecting;
import com.dac.base.client.pubsub.Publisher.Callback;
import com.dac.base.client.requests.Request;
import com.dac.base.config.Config;
...
import com.dac.base.core.types.known.tx.signed.SignedTransaction;
import com.dac.base.crypto.ecdsa.IKeyPair;
import com.dac.base.crypto.ecdsa.Seed;
import com.dac.base.encodings.B58IdentiferCodecs;
import com.dac.dac.crypto.Ecies;
import com.dac.dac.crypto.EncryptCommon;
import com.dac.dac.net.Connection;
import com.dac.dac.resources.Constant;
import com.dac.dac.util.EventManager;
import com.dac.dac.util.GenericPair;
import com.dac.dac.util.Util;
import com.dac.dac.util.Validate;

public class Dac extends Submit {
	...
	public static final Dac c = new Dac();
...
//			e.printStackTrace();
	 ...
	 * @return	You can use this to call other Dac functions continuely.
	 */
	public Dac createTable(String name, List<String> raw) {
	 ...
	 * @return You can use this to call other Dac functions continuely.
	 */
	public Dac createTable(String name, List<String> raw,JSONObject operationRule) {
	 ...
	 * @return You can use this to call other Dac functions continuely.
	 */
	public Dac createTable(String name, List<String> rawList ,boolean confidential) {
		return createTable(name,rawList,null,confidential);
	}
	
	private Dac createTable(String name, List<String> rawList, JSONObject operationRule,boolean confidential) {
	 ...
	 * @return You can use this to call other Dac functions continuely.
	 */
	public Dac recreateTable(String name){
		JSONObject json = new JSONObject();
	 ...
	 * @return You can use this to call other Dac functions continuely.
	 */
	public Dac dropTable(String name) {
		JSONObject json = new JSONObject();
	 ...
	 * @return You can use this to call other Dac functions continuely.
	 */
	public Dac renameTable(String oldName, String newName) {
	 ...
	 * @return You can use this to call other Dac functions continuely.
	 */
	public Dac grant(String name, String user,String userPublicKey,String flag){
		String token = "";
	 ...
	 * @return You can use this to call other Dac functions continuely.
	 */
	public Dac grant(String name, String user,String flag) {
		return grant_inner(name,user,flag,"");
	}

	private Dac grant_inner(String name, String user,String flag,String token) {
	...
	public String getAccountBalance(String address){
		try{
			...
			if(request.response.result!=null){
				...
				BigInteger dac = bal.divide(BigInteger.valueOf(1000000));
				BigInteger mod = bal.mod(BigInteger.valueOf(1000000));
				String finalZxc = dac.toString();
				finalZxc += ".";
