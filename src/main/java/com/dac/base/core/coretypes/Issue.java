...
public class Issue implements Comparable<Issue> {
    ...
    public static final Issue DAC = fromString("DAC");
    ...
    private static Issue fromStringPair(String[] split) {
        ...
        } else if (split[0].equals("DAC")) {
            return new Issue(Currency.DAC, AccountID.XRP_ISSUER);
        } else {
            throw new RuntimeException("Issue string must be DAC or $currency/$issuer");
        }
    }

    /**
     * See {@link com.dac.base.core.fields.Field#TakerGetsCurrency}
     * See {@link com.dac.base.core.fields.Field#TakerGetsIssuer}
     *
    ...
    public boolean isNative() {
        return this == DAC || currency.equals(Currency.DAC);
    }
