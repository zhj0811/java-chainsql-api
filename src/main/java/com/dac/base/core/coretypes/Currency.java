...
public class Currency extends Hash160 {
    ...
    public static final Currency DAC = new Currency(BigInteger.ZERO.toByteArray());
    ...
    public boolean isNative() {
        return this == Currency.DAC || equals(Currency.DAC);
    }
...
//                }
    ...
    * usage of Currency objects, just String with "DAC" ambiguity.
    * */
