package com.dac.base.core.serialized.enums;

import com.dac.base.core.fields.Type;
import com.dac.base.core.serialized.BinaryParser;
import com.dac.base.core.serialized.BytesSink;
import com.dac.base.core.serialized.SerializedType;
import com.dac.base.core.serialized.TypeTranslator;
import com.dac.base.encodings.common.B16;
...
public enum EngineResult implements SerializedType
{
    ...
    temBAD_FEE (-294, "Invalid fee, negative or not DAC."),
    ...
    temBAD_SEND_XRP_LIMIT (-288, "Malformed: Limit quality is not allowed for DAC to DAC."),
    temBAD_SEND_XRP_MAX (-287, "Malformed: Send max is not allowed for DAC to DAC."),
    temBAD_SEND_XRP_NO_DIRECT (-286, "Malformed: No Ripple direct is not allowed for DAC to DAC."),
    temBAD_SEND_XRP_PARTIAL (-285, "Malformed: Partial payment is not allowed for DAC to DAC."),
    temBAD_SEND_XRP_PATHS (-284, "Malformed: Paths are not allowed for DAC to DAC."),
    ...
    tecUNFUNDED_ADD (102, "Insufficient DAC balance for WalletAdd."),
    tecUNFUNDED_OFFER (103, "Insufficient balance to fund created offer."),
    tecUNFUNDED_PAYMENT (104, "Insufficient DAC balance to send."),
    ...
    tecNO_DST (124, "Destination does not exist. Send DAC to create it."),
    tecNO_DST_INSUF_XRP (125, "Destination does not exist. Too little DAC sent to create it."),
