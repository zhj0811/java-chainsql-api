package com.idac.base.core.serialized.enums;
...
import com.idac.base.core.serialized.TypeTranslator;
...
public enum EngineResult implements SerializedType
{
    ...
    temBAD_FEE (-294, "Invalid fee, negative or not IDAC."),
    ...
    temBAD_SEND_XRP_LIMIT (-288, "Malformed: Limit quality is not allowed for IDAC to IDAC."),
    temBAD_SEND_XRP_MAX (-287, "Malformed: Send max is not allowed for IDAC to IDAC."),
    temBAD_SEND_XRP_NO_DIRECT (-286, "Malformed: No Ripple direct is not allowed for IDAC to IDAC."),
    temBAD_SEND_XRP_PARTIAL (-285, "Malformed: Partial payment is not allowed for IDAC to IDAC."),
    temBAD_SEND_XRP_PATHS (-284, "Malformed: Paths are not allowed for IDAC to IDAC."),
    ...
    tecUNFUNDED_ADD (102, "Insufficient IDAC balance for WalletAdd."),
    tecUNFUNDED_OFFER (103, "Insufficient balance to fund created offer."),
    tecUNFUNDED_PAYMENT (104, "Insufficient IDAC balance to send."),
    ...
    tecNO_DST (124, "Destination does not exist. Send IDAC to create it."),
    tecNO_DST_INSUF_XRP (125, "Destination does not exist. Too little IDAC sent to create it."),
