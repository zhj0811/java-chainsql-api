...
public class Issue implements Comparable<Issue> {
    ...
    public static final Issue IDAC = fromString("IDAC");
    ...
    private static Issue fromStringPair(String[] split) {
        ...
        } else if (split[0].equals("IDAC")) {
            return new Issue(Currency.IDAC, AccountID.XRP_ISSUER);
        } else {
            throw new RuntimeException("Issue string must be IDAC or $currency/$issuer");
        }
    }

    /**
     * See {@link com.idac.base.core.fields.Field#TakerGetsCurrency}
     * See {@link com.idac.base.core.fields.Field#TakerGetsIssuer}
     *
    ...
    public boolean isNative() {
        return this == IDAC || currency.equals(Currency.IDAC);
    }
