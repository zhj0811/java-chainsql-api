package com.idac.idac.core;

import static com.idac.base.config.Config.getB58IdentiferCodecs;
...
import com.idac.base.client.Client.OnReconnected;
import com.idac.base.client.Client.OnReconnecting;
import com.idac.base.client.pubsub.Publisher.Callback;
import com.idac.base.client.requests.Request;
import com.idac.base.config.Config;
...
import com.idac.base.core.types.known.tx.signed.SignedTransaction;
import com.idac.base.crypto.ecdsa.IKeyPair;
import com.idac.base.crypto.ecdsa.Seed;
import com.idac.base.encodings.B58IdentiferCodecs;
import com.idac.idac.crypto.Ecies;
import com.idac.idac.crypto.EncryptCommon;
import com.idac.idac.net.Connection;
import com.idac.idac.resources.Constant;
import com.idac.idac.util.EventManager;
import com.idac.idac.util.GenericPair;
	...
	public String getAccountBalance(String address){
		try{
			...
			if(request.response.result!=null){
				...
				BigInteger idac = bal.divide(BigInteger.valueOf(1000000));
				BigInteger mod = bal.mod(BigInteger.valueOf(1000000));
				String finalZxc = idac.toString();
				finalZxc += ".";
